...
public:
    ...
    vector<int> corpFlightBookings(vector<vector<int>>& bookings, int n) {
        ...
        for(auto b: bookings)
        {
            ...
            ans[b[1]] -= b[2]; //subtracting the value because when we come after doing prefix sums till this index, at this index it will become 0 after getting neutralised
        }
        for(int i=1; i<=n; i++)
